...
export function ProductCard({ id, name, price, weight, image, category }: ProductCardProps) {
  ...
  return (
    <Card className="group overflow-hidden border-border bg-card hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10 transition-all duration-300">
      ...
      <div className="absolute top-2 right-2 z-10">
        <Button
          variant="ghost"
          size="icon"
          className="h-9 w-9 rounded-full bg-background/80 hover:bg-background hover:scale-110 backdrop-blur-sm transition-all duration-200"
      ...
      <div className="p-3">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <Button
            size="sm"
            className="h-9 hover:scale-105 active:scale-95 transition-transform duration-200"
